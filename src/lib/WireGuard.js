...
Address = ${config.server.addressIPv4}/24, ${config.server.addressIPv6}/56
ListenPort = 51820
PreUp = ${WG_PRE_UP}
PostUp = ${WG_POST_UP}
PreDown = ${WG_PRE_DOWN}
...
Address = ${client.addressIPv4}/24, ${client.addressIPv6}/56
...
Endpoint = ${WG_HOST}:${WG_PORT}`;
  ...
  async updateClientAddressIPv4({ clientId, addressIPv4 }) {
    ...
    if (!Util.isValidIPv4(addressIPv4)) {
      throw new ServerError(`Invalid IPv4 Address: ${addressIPv4}`, 400);
    }
  ...
  async updateClientAddressIPv6({ clientId, addressIPv6 }) {
    ...
    if (!Util.isValidIPv6(addressIPv6)) {
